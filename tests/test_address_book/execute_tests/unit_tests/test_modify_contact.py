...
#
#
# def assert_name_modification(book, parameters):
#     new_name = fake.name()
...
#
#
# def assert_address_modification(book, name, parameters):
...
#
#
# def assert_phone_modification(book, name, parameters):
...
#
#
# def test_address_book_modify_contact(book, add_contact, parameters):
#     new_name = assert_name_modification(book, parameters)
#     assert_address_modification(book, new_name, parameters)
#     assert_email_modification(book, new_name)
#     assert_phone_modification(book, new_name, parameters)
